...
module.exports = {
    name: "setmessagegoodbye",
    description: "Permet de configurer le message de départ",
    ...
    async run(bot, message, args) {
        const selectMenu = new Discord.ActionRowBuilder()
            .addComponents(
                new Discord.StringSelectMenuBuilder()
                    ...
                    .setPlaceholder('Choisissez une partie du message de départ à configurer')
                    .addOptions([
        ...
        await message.reply({ content: "Sélectionnez l'élément du message de départ à personnaliser :", components: [selectMenu], ephemeral: true });
        ...
        collector.on('collect', async interaction => {
            ...
            interaction.awaitModalSubmit({ filter: modalFilter, time: 60000 })
                .then(async modalInteraction => {
                    ...
                    if (!data[guildId].goodbyembed) data[guildId].goodbyembed = {};
                    data[guildId].goodbyembed[selectedOption] = newValue;
